...
__device__ void fe25519_mul(fe25519 h, const fe25519 f, const fe25519 g) {
    ...
    s32 g8 = g[8];
    s32 g9 = g[9];
    s32 g1_19 = 19 * g1; /* 1.959375*2^29 */
    s32 g2_19 = 19 * g2; /* 1.959375*2^30; still ok */
    s32 g3_19 = 19 * g3;
    s32 g4_19 = 19 * g4;
    s32 g5_19 = 19 * g5;
    s32 g6_19 = 19 * g6;
    ...
    s64 f0g9 = f0 * (s64)g9;
    s64 f1g0 = f1 * (s64)g0;
    s64 f1g1_2 = f1_2 * (s64)g1;
    s64 f1g2 = f1 * (s64)g2;
    s64 f1g3_2 = f1_2 * (s64)g3;
    s64 f1g4 = f1 * (s64)g4;
    s64 f1g5_2 = f1_2 * (s64)g5;
    s64 f1g6 = f1 * (s64)g6;
    s64 f1g7_2 = f1_2 * (s64)g7;
    s64 f1g8 = f1 * (s64)g8;
    s64 f1g9_38 = f1_2 * (s64)g9_19;
    s64 f2g0 = f2 * (s64)g0;
    s64 f2g1 = f2 * (s64)g1;
    s64 f2g2 = f2 * (s64)g2;
    s64 f2g3 = f2 * (s64)g3;
    ...
    s64 f2g6 = f2 * (s64)g6;
    s64 f2g7 = f2 * (s64)g7;
    s64 f2g8_19 = f2 * (s64)g8_19;
    s64 f2g9_19 = f2 * (s64)g9_19;
    s64 f3g0 = f3 * (s64)g0;
    s64 f3g1_2 = f3_2 * (s64)g1;
    s64 f3g2 = f3 * (s64)g2;
    s64 f3g3_2 = f3_2 * (s64)g3;
    s64 f3g4 = f3 * (s64)g4;
    s64 f3g5_2 = f3_2 * (s64)g5;
    s64 f3g6 = f3 * (s64)g6;
    s64 f3g7_38 = f3_2 * (s64)g7_19;
    s64 f3g8_19 = f3 * (s64)g8_19;
    s64 f3g9_38 = f3_2 * (s64)g9_19;
    s64 f4g0 = f4 * (s64)g0;
    s64 f4g1 = f4 * (s64)g1;
    s64 f4g2 = f4 * (s64)g2;
    s64 f4g3 = f4 * (s64)g3;
    s64 f4g4 = f4 * (s64)g4;
    s64 f4g5 = f4 * (s64)g5;
    s64 f4g6_19 = f4 * (s64)g6_19;
    s64 f4g7_19 = f4 * (s64)g7_19;
    s64 f4g8_19 = f4 * (s64)g8_19;
    s64 f4g9_19 = f4 * (s64)g9_19;
    s64 f5g0 = f5 * (s64)g0;
    s64 f5g1_2 = f5_2 * (s64)g1;
    s64 f5g2 = f5 * (s64)g2;
    s64 f5g3_2 = f5_2 * (s64)g3;
    s64 f5g4 = f5 * (s64)g4;
    s64 f5g5_38 = f5_2 * (s64)g5_19;
    s64 f5g6_19 = f5 * (s64)g6_19;
    s64 f5g7_38 = f5_2 * (s64)g7_19;
    s64 f5g8_19 = f5 * (s64)g8_19;
    s64 f5g9_38 = f5_2 * (s64)g9_19;
    s64 f6g0 = f6 * (s64)g0;
    s64 f6g1 = f6 * (s64)g1;
    s64 f6g2 = f6 * (s64)g2;
    s64 f6g3 = f6 * (s64)g3;
    s64 f6g4_19 = f6 * (s64)g4_19;
    s64 f6g5_19 = f6 * (s64)g5_19;
    s64 f6g6_19 = f6 * (s64)g6_19;
    s64 f6g7_19 = f6 * (s64)g7_19;
    s64 f6g8_19 = f6 * (s64)g8_19;
    s64 f6g9_19 = f6 * (s64)g9_19;
    s64 f7g0 = f7 * (s64)g0;
    s64 f7g1_2 = f7_2 * (s64)g1;
    s64 f7g2 = f7 * (s64)g2;
    s64 f7g3_38 = f7_2 * (s64)g3_19;
    s64 f7g4_19 = f7 * (s64)g4_19;
    s64 f7g5_38 = f7_2 * (s64)g5_19;
    s64 f7g6_19 = f7 * (s64)g6_19;
    s64 f7g7_38 = f7_2 * (s64)g7_19;
    s64 f7g8_19 = f7 * (s64)g8_19;
    s64 f7g9_38 = f7_2 * (s64)g9_19;
    s64 f8g0 = f8 * (s64)g0;
    s64 f8g1 = f8 * (s64)g1;
    s64 f8g2_19 = f8 * (s64)g2_19;
    s64 f8g3_19 = f8 * (s64)g3_19;
    s64 f8g4_19 = f8 * (s64)g4_19;
    s64 f8g5_19 = f8 * (s64)g5_19;
    s64 f8g6_19 = f8 * (s64)g6_19;
    s64 f8g7_19 = f8 * (s64)g7_19;
    s64 f8g8_19 = f8 * (s64)g8_19;
    s64 f8g9_19 = f8 * (s64)g9_19;
    s64 f9g0 = f9 * (s64)g0;
    s64 f9g1_38 = f9_2 * (s64)g1_19;
    s64 f9g2_19 = f9 * (s64)g2_19;
    s64 f9g3_38 = f9_2 * (s64)g3_19;
    s64 f9g4_19 = f9 * (s64)g4_19;
    s64 f9g5_38 = f9_2 * (s64)g5_19;
    s64 f9g6_19 = f9 * (s64)g6_19;
    s64 f9g7_38 = f9_2 * (s64)g7_19;
    s64 f9g8_19 = f9 * (s64)g8_19;
    s64 f9g9_38 = f9_2 * (s64)g9_19;
    s64 h0 = f0g0 + f1g9_38 + f2g8_19 + f3g7_38 + f4g6_19 + f5g5_38 +
                 f6g4_19 + f7g3_38 + f8g2_19 + f9g1_38;
    s64 h1 = f0g1 + f1g0 + f2g9_19 + f3g8_19 + f4g7_19 + f5g6_19 + f6g5_19 +
                 f7g4_19 + f8g3_19 + f9g2_19;
    s64 h2 = f0g2 + f1g1_2 + f2g0 + f3g9_38 + f4g8_19 + f5g7_38 + f6g6_19 +
                 f7g5_38 + f8g4_19 + f9g3_38;
    s64 h3 = f0g3 + f1g2 + f2g1 + f3g0 + f4g9_19 + f5g8_19 + f6g7_19 +
                 f7g6_19 + f8g5_19 + f9g4_19;
    s64 h4 = f0g4 + f1g3_2 + f2g2 + f3g1_2 + f4g0 + f5g9_38 + f6g8_19 +
                 f7g7_38 + f8g6_19 + f9g5_38;
    s64 h5 = f0g5 + f1g4 + f2g3 + f3g2 + f4g1 + f5g0 + f6g9_19 + f7g8_19 +
                 f8g7_19 + f9g6_19;
    s64 h6 = f0g6 + f1g5_2 + f2g4 + f3g3_2 + f4g2 + f5g1_2 + f6g0 +
                 f7g9_38 + f8g8_19 + f9g7_38;
    s64 h7 = f0g7 + f1g6 + f2g5 + f3g4 + f4g3 + f5g2 + f6g1 + f7g0 +
                 f8g9_19 + f9g8_19;
    s64 h8 = f0g8 + f1g7_2 + f2g6 + f3g5_2 + f4g4 + f5g3_2 + f6g2 + f7g1_2 +
                 f8g0 + f9g9_38;
    s64 h9 =
    ...
    carry0 = (h0 + (s64)(1 << 25)) >> 26;
    h1 += carry0;
    h0 -= carry0 << 26;
    carry4 = (h4 + (s64)(1 << 25)) >> 26;
    h5 += carry4;
    h4 -= carry4 << 26;

    carry1 = (h1 + (s64)(1 << 24)) >> 25;
    h2 += carry1;
    h1 -= carry1 << 25;
    carry5 = (h5 + (s64)(1 << 24)) >> 25;
    h6 += carry5;
    h5 -= carry5 << 25;

    carry2 = (h2 + (s64)(1 << 25)) >> 26;
    h3 += carry2;
    h2 -= carry2 << 26;
    carry6 = (h6 + (s64)(1 << 25)) >> 26;
    h7 += carry6;
    h6 -= carry6 << 26;

    carry3 = (h3 + (s64)(1 << 24)) >> 25;
    h4 += carry3;
    h3 -= carry3 << 25;
    carry7 = (h7 + (s64)(1 << 24)) >> 25;
    h8 += carry7;
    h7 -= carry7 << 25;
    ...
    h5 += carry4;
    h4 -= carry4 << 26;
    carry8 = (h8 + (s64)(1 << 25)) >> 26;
    h9 += carry8;
    h8 -= carry8 << 26;

    carry9 = (h9 + (s64)(1 << 24)) >> 25;
    h0 += carry9 * 19;
    h9 -= carry9 << 25;
...
__device__ void fe25519_sq(fe25519 h, const fe25519 f) {
    ...
    s32 f6_2  = 2 * f6;
    s32 f7_2  = 2 * f7;
    s32 f5_38 = 38 * f5; /* 1.959375*2^30 */
    s32 f6_19 = 19 * f6; /* 1.959375*2^30 */
    s32 f7_38 = 38 * f7; /* 1.959375*2^30 */
    s32 f8_19 = 19 * f8; /* 1.959375*2^30 */
    s32 f9_38 = 38 * f9; /* 1.959375*2^30 */

    s64 f0f0    = f0 * (s64) f0;
    s64 f0f1_2  = f0_2 * (s64) f1;
    s64 f0f2_2  = f0_2 * (s64) f2;
    s64 f0f3_2  = f0_2 * (s64) f3;
    s64 f0f4_2  = f0_2 * (s64) f4;
    s64 f0f5_2  = f0_2 * (s64) f5;
    s64 f0f6_2  = f0_2 * (s64) f6;
    s64 f0f7_2  = f0_2 * (s64) f7;
    s64 f0f8_2  = f0_2 * (s64) f8;
    s64 f0f9_2  = f0_2 * (s64) f9;
    s64 f1f1_2  = f1_2 * (s64) f1;
    s64 f1f2_2  = f1_2 * (s64) f2;
    s64 f1f3_4  = f1_2 * (s64) f3_2;
    s64 f1f4_2  = f1_2 * (s64) f4;
    s64 f1f5_4  = f1_2 * (s64) f5_2;
    s64 f1f6_2  = f1_2 * (s64) f6;
    s64 f1f7_4  = f1_2 * (s64) f7_2;
    s64 f1f8_2  = f1_2 * (s64) f8;
    s64 f1f9_76 = f1_2 * (s64) f9_38;
    s64 f2f2    = f2 * (s64) f2;
    s64 f2f3_2  = f2_2 * (s64) f3;
    s64 f2f4_2  = f2_2 * (s64) f4;
    s64 f2f5_2  = f2_2 * (s64) f5;
    s64 f2f6_2  = f2_2 * (s64) f6;
    s64 f2f7_2  = f2_2 * (s64) f7;
    s64 f2f8_38 = f2_2 * (s64) f8_19;
    s64 f2f9_38 = f2 * (s64) f9_38;
    s64 f3f3_2  = f3_2 * (s64) f3;
    s64 f3f4_2  = f3_2 * (s64) f4;
    s64 f3f5_4  = f3_2 * (s64) f5_2;
    s64 f3f6_2  = f3_2 * (s64) f6;
    s64 f3f7_76 = f3_2 * (s64) f7_38;
    s64 f3f8_38 = f3_2 * (s64) f8_19;
    s64 f3f9_76 = f3_2 * (s64) f9_38;
    s64 f4f4    = f4 * (s64) f4;
    s64 f4f5_2  = f4_2 * (s64) f5;
    s64 f4f6_38 = f4_2 * (s64) f6_19;
    s64 f4f7_38 = f4 * (s64) f7_38;
    s64 f4f8_38 = f4_2 * (s64) f8_19;
    s64 f4f9_38 = f4 * (s64) f9_38;
    s64 f5f5_38 = f5 * (s64) f5_38;
    s64 f5f6_38 = f5_2 * (s64) f6_19;
    s64 f5f7_76 = f5_2 * (s64) f7_38;
    s64 f5f8_38 = f5_2 * (s64) f8_19;
    s64 f5f9_76 = f5_2 * (s64) f9_38;
    s64 f6f6_19 = f6 * (s64) f6_19;
    s64 f6f7_38 = f6 * (s64) f7_38;
    s64 f6f8_38 = f6_2 * (s64) f8_19;
    s64 f6f9_38 = f6 * (s64) f9_38;
    s64 f7f7_38 = f7 * (s64) f7_38;
    s64 f7f8_38 = f7_2 * (s64) f8_19;
    s64 f7f9_76 = f7_2 * (s64) f9_38;
    s64 f8f8_19 = f8 * (s64) f8_19;
    s64 f8f9_38 = f8 * (s64) f9_38;
    s64 f9f9_38 = f9 * (s64) f9_38;

    s64 h0 = f0f0 + f1f9_76 + f2f8_38 + f3f7_76 + f4f6_38 + f5f5_38;
    s64 h1 = f0f1_2 + f2f9_38 + f3f8_38 + f4f7_38 + f5f6_38;
    s64 h2 = f0f2_2 + f1f1_2 + f3f9_76 + f4f8_38 + f5f7_76 + f6f6_19;
    s64 h3 = f0f3_2 + f1f2_2 + f4f9_38 + f5f8_38 + f6f7_38;
    s64 h4 = f0f4_2 + f1f3_4 + f2f2 + f5f9_76 + f6f8_38 + f7f7_38;
    s64 h5 = f0f5_2 + f1f4_2 + f2f3_2 + f6f9_38 + f7f8_38;
    s64 h6 = f0f6_2 + f1f5_4 + f2f4_2 + f3f3_2 + f7f9_76 + f8f8_19;
    s64 h7 = f0f7_2 + f1f6_2 + f2f5_2 + f3f4_2 + f8f9_38;
    s64 h8 = f0f8_2 + f1f7_4 + f2f6_2 + f3f5_4 + f4f4 + f9f9_38;
    s64 h9 = f0f9_2 + f1f8_2 + f2f7_2 + f3f6_2 + f4f5_2;
    ...
    carry0 = (h0 + (s64)(1L << 25)) >> 26;
    h1 += carry0;
    h0 -= carry0 * ((u64) 1L << 26);
    carry4 = (h4 + (s64)(1L << 25)) >> 26;
    h5 += carry4;
    h4 -= carry4 * ((u64) 1L << 26);

    carry1 = (h1 + (s64)(1L << 24)) >> 25;
    h2 += carry1;
    h1 -= carry1 * ((u64) 1L << 25);
    carry5 = (h5 + (s64)(1L << 24)) >> 25;
    h6 += carry5;
    h5 -= carry5 * ((u64) 1L << 25);

    carry2 = (h2 + (s64)(1L << 25)) >> 26;
    h3 += carry2;
    h2 -= carry2 * ((u64) 1L << 26);
    carry6 = (h6 + (s64)(1L << 25)) >> 26;
    h7 += carry6;
    h6 -= carry6 * ((u64) 1L << 26);

    carry3 = (h3 + (s64)(1L << 24)) >> 25;
    h4 += carry3;
    h3 -= carry3 * ((u64) 1L << 25);
    carry7 = (h7 + (s64)(1L << 24)) >> 25;
    h8 += carry7;
    h7 -= carry7 * ((u64) 1L << 25);
    ...
    h5 += carry4;
    h4 -= carry4 * ((u64) 1L << 26);
    carry8 = (h8 + (s64)(1L << 25)) >> 26;
    h9 += carry8;
    h8 -= carry8 * ((u64) 1L << 26);

    carry9 = (h9 + (s64)(1L << 24)) >> 25;
    h0 += carry9 * 19;
    h9 -= carry9 * ((u64) 1L << 25);
...
__device__ __forceinline__ u64 load_3(const unsigned char *in) {
    u64 result;
...
__device__ __forceinline__ u64 load_4(const unsigned char *in) {
    u64 result;
...
__device__ void fe25519_frombytes(fe25519 h, const unsigned char *s) {
    ...
    s64 h1 = load_3(s + 4) << 6;
    s64 h2 = load_3(s + 7) << 5;
    s64 h3 = load_3(s + 10) << 3;
    s64 h4 = load_3(s + 13) << 2;
    s64 h5 = load_4(s + 16);
    s64 h6 = load_3(s + 20) << 7;
    s64 h7 = load_3(s + 23) << 5;
    s64 h8 = load_3(s + 26) << 4;
    s64 h9 = (load_3(s + 29) & 8388607) << 2;

    s64 carry0, carry1, carry2, carry3, carry4, carry5, carry6, carry7, carry8, carry9;

    carry9 = (h9 + (s64)(1 << 24)) >> 25; h0 += carry9*19; h9 -= carry9 << 25;
    carry1 = (h1 + (s64)(1 << 24)) >> 25; h2 += carry1;    h1 -= carry1 << 25;
    carry3 = (h3 + (s64)(1 << 24)) >> 25; h4 += carry3;    h3 -= carry3 << 25;
    carry5 = (h5 + (s64)(1 << 24)) >> 25; h6 += carry5;    h5 -= carry5 << 25;
    carry7 = (h7 + (s64)(1 << 24)) >> 25; h8 += carry7;    h7 -= carry7 << 25;
    carry0 = (h0 + (s64)(1 << 25)) >> 26; h1 += carry0;    h0 -= carry0 << 26;
    carry2 = (h2 + (s64)(1 << 25)) >> 26; h3 += carry2;    h2 -= carry2 << 26;
    carry4 = (h4 + (s64)(1 << 25)) >> 26; h5 += carry4;    h4 -= carry4 << 26;
    carry6 = (h6 + (s64)(1 << 25)) >> 26; h7 += carry6;    h6 -= carry6 << 26;
    carry8 = (h8 + (s64)(1 << 25)) >> 26; h9 += carry8;    h8 -= carry8 << 26;
...
__device__ int ge25519_frombytes(ge25519_p3 *h, const unsigned char *s) {
    ...
    fe25519_cmov(h->X, negx, fe25519_isnegative(h->X) ^ (((s[31] >> 5) ^ 0) >> 2));
...
__device__ unsigned char negative(signed char b) {
    ...
    return x;
#else
    const u8 x = (u8) b; /* 0..127: no 128..255: yes */
    return ((x >> 5) ^ 0) >> 2; /* 1: yes; 0: no */
#endif
}

__device__ unsigned char equal(signed char b, signed char c) {
#if defined(HAVE_INLINE_ASM) && defined(__x86_64__)
    s32 b32 = (s32) b, c32 = (s32) c, q32, z32;
    __asm__ ("xorl %0,%0\n movl $1,%1\n cmpb %b3,%b2\n cmovel %1,%0" :
    ...
    u32            y  = (u32) x; /* 0: yes; 1..255: no */

    y--;
    return ((y >> 29) ^ 0) >> 2; /* 1: yes; 0: no */
#endif
}
